...
Бот-витрина проектов: создай карточку — после одобрения она попадёт в ленту канала.
Создай проект → заполни форму → отправь на модерацию → после одобрения попадёт в ленту."""
